        ...
        <Grid className={classes.block} container spacing={3}>
          <Grid item xs={12} sm={12} md={4} lg={4}>
            <h3 className={classes.lowerHeaderText}>Complete Field Solution </h3>
              ...
              Built through years of continuous development, PRAMS is a complete field solution created with the most dynamic gauge-sheet style data capture tool. Unlike our competitors, tanks, site inspections, unlimited meters, and equipment metrics - all at the pumpers fingertip's.</p>
          </Grid>
          <Grid item xs={12} sm={12} md={4} lg={4}>
